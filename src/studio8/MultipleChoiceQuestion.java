...
public class MultipleChoiceQuestion extends Question {
	...
	public MultipleChoiceQuestion(String prompt, String answer, int points, String[] choices) {
		super(prompt, answer, points); //calls the Question() constructor
	...
	public static void main(String[] args) {
		...
		Question multipleChoice = new MultipleChoiceQuestion("What studio is this?", choices[2], 1, choices);
		...
		System.out.println(multipleChoice.checkAnswer(choices[2]));//right
	}
